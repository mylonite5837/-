...
BG_FILE = r'E:\pythonProject\big_6a00144c54c73d136b8315b1edf9b1d6.png'
...
if __name__ == '__main__':
    write_couplets('旧岁又添几个喜', horv='V', quality='H')
    write_couplets('新年更上一层楼', horv='V', quality='H')
    write_couplets('辞旧迎新', horv='H', quality='H')